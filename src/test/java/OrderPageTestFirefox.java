...
public class OrderPageTestFirefox {
    ...
    public OrderPageTestFirefox(String name, String surName, String address, String subway, String phone, String date, String color, String rent, String comment) {
        this.name = name;
